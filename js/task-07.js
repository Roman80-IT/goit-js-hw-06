...
//* Щоб забезпечити синхронізацію розміру тексту при завантаженні сторінки і після зміни значення повзунка,
//* потрібно викликати ф-цію sizeCtrl один раз після того, як сторінка завантажується, і ще раз відразу після того, як змінюється значення повзунка.
sizeCtrl();
